...
public class FoodCorner {
    ...
    private void MainMenu() {
        ...
        do{
            ...
            switch (choice) {
                case 'S':ShowStarterChoice(FrenchFries, MacCheese, Coleslaw);
                    break;
    ...
    private void ShowStarterChoice(double FrenchFries, double MacCheese, double Coleslaw) {
    ...
    private void ShowMainChoice(double Steak, double FishChips, double ChickenChop) {
    ...
    private void ShowDessertChoice(double Pancakes, double Waffles, double IceCream) {
